...
import br.com.techgold.modelo.Relatorio;
import br.com.techgold.dao.ClienteDao;
import br.com.techgold.dao.ComputadorDao;
...
public class SolicitacaoController {
	...
	private void GravaSolicTecAdmin(Solicitacao solicitacao, String nomeDoCliente, String nomeDoFuncionario) {
		...
		if (solicitacao.getStatus().equals("Agendar")) {
			solicitacao.setStatus("Agendado"); // Em revisao
		...
		if (solicitacao.getStatus().equals("Em andamento")) {
			solicitacao.setStatus("Em andamento"); // Em revisao
	...
	public String funcionarioEdit(Long id, HttpSession session, Model model) {
		...
		if (funcionario != null) {
			...
			// Administrador pode editar qualquer solicitacao
			...
			// Somente visualiza as demais solicitacoes
			else {
